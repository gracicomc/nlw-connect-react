...
export function InputIcon(props: InputIconProps) {
  return (
    <span
      ...
      {...props}
      //group-focus-within:text-gray-100  agrupa para pegar o hover do grupo da div acima e regra para quando o placeholder tiver conteúdo, o ícone fica com a cor gray-100
    />
  );
}
...
//Modo convencional, como eu costumo fazer:
